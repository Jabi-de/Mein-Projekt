...
// Abfrage an die Datenbank senden, um alle Einträge abzurufen und nach der ID absteigend zu sortieren
if (empty($terminId)) {
...
$checklistMap = []; // Array zur Gruppierung der Einträge nach Hauptaufgabe
...
<div class="container-fluid">
    <button type="button" class="btn btn-primary btn-lg">
        <a class="text-white" href="insert_seit.php?insert=">Eintrag Hinzufügen</a>
    </button>
</div>
